...
// 
/**
 * changed variable and should move left and right. commenting out DHT helped
 * 
 * Made sure it also kept the old circle so it made the screen white as it went across
 */
#include <Wire.h>
...
*/
  ...
  */
  ...
  if (unfiltered_gyro_angle_x > 10 || unfiltered_gyro_angle_x < -10){ //resets display when shook
     display.clearDisplay();
